...
abstract public class Planet // visibility widened
{
    public static Planet[] sPlanets; // visibility widened
    public static Planet sEarth; // visibility widened

    public String mName; // visibility widened
    ...
    public abstract void calcHeliocentric(GregorianCalendar date); // visibility widened
}
...
abstract class PlanetCsv extends Planet
{
    ...
    public void calcHeliocentric(GregorianCalendar date) // visibility widened
    {
