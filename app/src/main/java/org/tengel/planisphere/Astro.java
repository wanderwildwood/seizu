...
public class Astro // visibility widened
{
     ...
     */
    public static double julian_date(Calendar c) // visibility widened
    {
     ...
     */
    // visibility widened
    public static double sidereal_time(int sY, int sM, int sD, double sUT)
    {
     ...
     */
    // visibility widened
    public static double[] geoEqua2geoHori(double t, double phi, double delta)
    {
     ...
     */
    // visibility widened
    public static double[] geoEcl2geoEqua(double beta, double lamb)
    {
     ...
     */
    // visibility widened
    public static double[] calcPositionSun(double jd)
    {
     ...
     */
    // visibility widened
    public static double[] calcPositionMoon(double jd)
    {
