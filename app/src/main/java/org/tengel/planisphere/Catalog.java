...
public class Catalog // visibility widened
{
    static Pattern sPattern = Pattern.compile(" +");

    public class Entry // visibility widened
    {
        public int hr; // visibility widened
        public String name; // visibility widened
        public String bayerFlamsteed; // visibility widened
        public double rightAscension; // visibility widened
        public double declination; // visibility widened
        public double apparentMagnitude; // visibility widened
